...
public class PropertiesConfigurationUtil {
    ...
    static {
        ...
        try {
            ...
            //TODO merge connection.props with application-prod.properties
        } catch (Exception e) {
            logger.error("Error setting property file:", e);

            if (!debug) { // if connection.props is not present
    ...
    public static Credentials getCredentials() {
        ...
        if (login != null) {
            ...
            logger.info("No information provided for ArchivesSpace. Provide connection.props.");
        }
